...
public class DRSServer_Montreal implements Runnable{
	
	private static DRSCommonServiceServerImpl servant = null;
...
//			nc.bind(nc.to_name(servant.svrName), obj);
			...
			System.out.println("RM1: " + servant.svrName + " is ready...");
	...
	public static void svrStart() {
		(new Thread(new DRSServer_Montreal())).start();
	}
}
