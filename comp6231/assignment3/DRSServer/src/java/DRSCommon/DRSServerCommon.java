 ...
 * $Rev: 181 $
 * $HeadURL: https://all-projects-concordia.googlecode.com/svn/comp6231/assignment3/src/common/DRSServerCommon.java $
 * 
 */
package DRSCommon;
...
public class DRSServerCommon {
	...
	public DRSServerCommon(String name) {
		...
		htItems.put("" + (Integer.parseInt(TEST_ITEMID) + 1), 10);
