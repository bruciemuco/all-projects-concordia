...
public class Server_AOM_M implements Runnable{
	
	static DRSCommonServiceServerImpl servant1 = null;

	public static void main(String[] args) {
		createSvr(SvrInfo.SVR2_NAME_MONTREAL);
	...
	public static void createSvr(String svrName) {
		...
		try {
			...
			POA poa = poaRoot.create_POA("DRSServerImpl_poa",	
...
// 		   	ps.println(orb.object_to_string(obj));
	...
	public static void svrStart() {
		(new Thread(new Server_AOM_M())).start();
	}
}
