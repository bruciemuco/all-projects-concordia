 ...
 * $Rev: 147 $
 * $HeadURL: https://all-projects-concordia.googlecode.com/svn/comp6231/project1/drs-server/src/server/DRSServerImpl.java $
 * 
 */
...
public class DRSServerImpl extends UnicastRemoteObject implements DRSCommon {
	...
	protected DRSServerImpl(String name) throws RemoteException {
		svr.init(name, SvrInfo.SVR_PORT_TORONTO);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			String name = SvrInfo.SVR_NAME_TORONTO;
