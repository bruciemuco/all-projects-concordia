 ...
 * $Rev: 181 $
 * $HeadURL: https://all-projects-concordia.googlecode.com/svn/comp6231/assignment2/src/common/SysLogger.java $
 * 
 */
...
public class SysLogger {
	...
	public static void init(String filename) {
		...
		// add a file handler
		String path = System.getProperty("user.dir") + "\\logs\\" + filename;
