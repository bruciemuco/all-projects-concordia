package ca.com.Concordia.distributed.Ass_2.DRS_ServerTNT;
...
public class MyServiceServerImpl extends ca.com.Concordia.distributed.Ass_2.MyServer.MyServicePOA {
	...
	public MyServiceServerImpl() {
		...
		itemList.put("T00001", new Item("T00001"));
		itemList.put("T00002", new Item("T00002"));
	...
	public synchronized String exChange(String itemID1, String itemID2, int customerID,
			int numberOfItem) {
